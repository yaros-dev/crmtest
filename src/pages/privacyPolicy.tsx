...
import "../privacyCSS/privacyPage.css"
        ...
        <React.Fragment>
            <div className="privacy__wrapper">
                ...
                <div className="privacy__section">
                    <p>Effective date: May 19 , 2022</p>
                    <p>Leadell Inc ("us", "we", or "our") operates the https://leadell.agency/ website (the
                        "Service").</p>
                    ...
                    <p>We use your data to provide and improve the Service. By using the Service, you agree to the
                        ...
                        and Conditions, accessible from https://leadell.agency/</p>
                </div>
                <div className="privacy__section">
                    <div className="section__title">Information Collection And Use</div>
                    <p>We collect several different types of information for various purposes to provide and improve our
                        Service to you.</p>
                </div>
                <div className="privacy__section">
                    <div className="section__title">Types of Data Collected</div>
                    <div className="section__paragraph__title">Personal Data</div>
                    ...
                    <div className="section__paragraph__title">Usage Data</div>
                    <p>We may also collect information how the Service is accessed and used ("Usage Data"). This Usage
                        ...
                        diagnostic data.</p>
                    <div className="section__paragraph__title">Tracking &amp; Cookies Data</div>
                ...
                <div className="privacy__section">
                    <div className="section__title">Use of Data</div>
                    <p>Leadell Inc uses the collected data for various purposes:
                        <ul>
                ...
                <div className="privacy__section">
                    <div className="section__title">Transfer Of Data</div>
                    ...
                    <p>If you are located outside United States and choose to provide information to us, please note
                        that we transfer the data, including Personal Data, to United States\United Kingdom and process
                        it there.</p>
                    ...
                    <p>Leadell Inc will take all steps reasonably necessary to ensure that your data is treated securely
                ...
                <div className="privacy__section">
                    <div className="section__title">Disclosure Of Data</div>
                    <div className="section__paragraph__title">Legal Requirements</div>
                    <p>Leadell Inc may disclose your Personal Data in the good faith belief that such action is
                        necessary to:
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of Leadell Inc</li>
                ...
                <div className="privacy__section">
                    <div className="section__title">Security Of Data</div>
                ...
                <div className="privacy__section">
                    <div className="section__title">Service Providers</div>
                    ...
                    <div className="section__paragraph__title">Analytics</div>
                    <p>We may use third-party Service Providers to monitor and analyze the use of our Service.</p>
                    <div className="section__paragraph__title">Google Analytics</div>
                    ...
                    <p>For more information on the privacy practices of Google, please visit the Google Privacy & Terms
                        web page:</p>
                    <p><a href="https://policies.google.com/privacy?hl=en"
                          style={{textDecoration: "underline"}}>https://policies.google.com/privacy?hl=en</a></p>
                </div>
                <div className="privacy__section">
                    <div className="section__title">Links To Other Sites</div>
                ...
                <div className="privacy__section">
                    <div className="section__title">Children's Privacy</div>
                ...
                <div className="privacy__section">
                    <div className="section__title">Changes To This Privacy Policy</div>
                ...
                <div className="privacy__section" style={{paddingBottom: "200px"}}>
                    <div className="section__title">Contact Us</div>
                    <p>If you have any questions about this Privacy Policy, please contact us by email: <a href="mailto:welcome@leadell.agency" style={{textDecoration: "underline"}}>welcome@leadell.agency</a></p>
                </div>
            </div>
            <FooterSection email={"welcome@leadell.agency"} tel={"0"} />
        </React.Fragment>
    );
}